...
describe("head", () => {
  it("should throw an exception for undefined list", () => {
    ...
    expect(() => head(testList)).to.throw(expectedError, expectedMessage);
  });
  ...
  it("should return first element for non-empty list", () => {
    const testValue1 = uuid();
    const testValue2 = uuid();
    const testValue3 = uuid();
    const testList = [testValue1, testValue2, testValue3];
    const expectedResult = testValue1;
    const actualResult = head(testList);
